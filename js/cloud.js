...
window.addEventListener('load', (event) => {
    console.log('loding the cloud script');
    const wordCloud = document.getElementById('clouder');
    Clouder();
...
function Clouder(params) {
    ...
    function parametrize(p) {
        ...
        colorMax = p.colorMax ? parseColor(p.colorMax) : parseColor("#ffffff");
        colorMin = p.colorMin ? parseColor(p.colorMin) : parseColor("#737373");
        colorBgr = p.colorBgr ? parseColor(p.colorMin) : parseColor("#c1c1c1");
...
function createTags() {
    var elems = [];
    elems.push({ text: "UX<br/>UI", id: " you could say I am 9/10 in that ", weight: 0.5 });
    elems.push({ text: "Data<br/>Analysis", id: "you could say I am 6/10 in that", weight: 0.5 });
    elems.push({ text: "HTML<br/>", id: "you could say I am 8/10 in that", weight: 0.5 });
    elems.push({ text: "CSS<br/>", id: "you could say I am 8/10 in that", weight: 1 });
    elems.push({ text: "Java<br/>Script", id: "you could say I am 6/10 in that", weight: 1 });
    elems.push({ text: "Python<br/>", id: "you could say I am 6/10 in that", weight: 0.5 });
    elems.push({ text: "C++", id: "you could say I am 7/10 in that", weight: 1 });
    elems.push({ text: "Web analytics", id: "you could say I am 8/10 in that", weight: 0 });
    elems.push({ text: "statistics", id: " you could say I am 7/10 in that ", weight: 0 });
    elems.push({ text: "Qualitative and<br/> quantitative <br/>research", id: "you could say I am  8/10 in that", weight: 0.5 });
    elems.push({ text: "Product Management", id: "you could say I am 8/10", weight: 0.5 });
    elems.push({ text: "Product design", id: "you could say I am 7/10 in that", weight: 0 });
    elems.push({ text: "Machine learning", id: "you could say I am 6/10 in that", weight: 0.5 });
    elems.push({ text: "Entrepreneurship", id: "you could say I am 9/10 in that", weight: 0.5 });
    elems.push({ text: "Product strategy", id: "you could say I am 9/10 in that ", weight: 0 });
    elems.push({ text: "Electronics", id: "you could say I am7/10 in that ", weight: 0 });
    elems.push({ text: "Robotics", id: "you could say I am 7/10 in that ", weight: 1 });
    elems.push({ text: "VR AR", id: "you could say I am 7/10 in that", weight: 1 });
    elems.push({ text: "User centered design", id: "Listen to your users !!", weight: 1 });
    elems.push({ text: "Lover", id: "<3", weight: 1 });
    elems.push({ text: "Just contact me.. <br> And we'll take it from there", id: "Edenoffer7@gmail.com", weight: 1 });
    elems.push({ text: "Documentary junkie", id: "Who doesn't love the BBC planet earth?!?", weight: 1 });
    elems.push({ text: "Dog owner!", id: "Go to my instegram page to to see Renee the Most beautiful dog in the world", weight: 0 });
    elems.push({ text: "Data visualization", id: "you could say I am 9/10 in that", weight: 1 });
    elems.push({ text: "Foodie", id: "Oh yes I can cook!", weight: 1 });
    return elems;
} // createTags
